...
import { getMockLicences } from "../data/backend-data";
...
export const buildHandlers = () => {
  ...
  return [
    http.get(`${baseURL}/inte/patenti`, ({ request }) => {
      const resultArray = [
        HttpResponse.json(getPuntiPatente200Response(), { status: 200 }),
...
export const getPuntiPatente200Response = () => getMockLicences();

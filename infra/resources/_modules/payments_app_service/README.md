...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_payments"></a> [payments](#module\_payments) | pagopa-dx/azure-app-service/azurerm | ~> 0.0 |
| <a name="module_payments_app_service_autoscaler"></a> [payments\_app\_service\_autoscaler](#module\_payments\_app\_service\_autoscaler) | pagopa-dx/azure-app-service-plan-autoscaler/azurerm | ~> 0.0 |
| <a name="module_payments_app_service_roles"></a> [payments\_app\_service\_roles](#module\_payments\_app\_service\_roles) | pagopa-dx/azure-role-assignments/azurerm | ~> 0.0 |
| <a name="module_payments_app_service_staging_roles"></a> [payments\_app\_service\_staging\_roles](#module\_payments\_app\_service\_staging\_roles) | pagopa-dx/azure-role-assignments/azurerm | ~> 0.0 |

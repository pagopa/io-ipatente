...
locals {
  vehicles = {
    ...
    base_app_settings = {
      ...
      AUTH_URL        = "https://ipatente.io.pagopa.it/veh/"

      OIDC_ISSUER_URL          = "https://ipatente.io.pagopa.it/veh/api/auth/mocks/oidc"
      ...
      OIDC_CLIENT_REDIRECT_URI = "https://ipatente.io.pagopa.it/veh/api/auth/callback/fims"
      ...
      NEXT_PUBLIC_BFF_API_BASE_URL  = "https://ipatente.io.pagopa.it/veh"

...
#   target_service = {
#     app_service_name = module.licences.app_service.app_service.name
#   }

#   scheduler = {
#     maximum = local.licences.autoscale_settings.max
#     normal_load = {
#       default = local.licences.autoscale_settings.default
#       minimum = local.licences.autoscale_settings.min
#     }
#   }
